            ...
            <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
                <div class="warp-border">
                    <div class="clearfix">
                        ...
                        <div class="text">
                            <h4 class="">${career.developmentDirection}</h4>
                    ...
                    <div class="warp-class2">
                        <div class="warp-class2-text">
                            <div class="iconfont text-padding">成长周期 <span class="iconfont-color">${job.growth}</span>年
                            </div>
                        </div>
                        <div class="warp-class2-text">
                            <div class="iconfont text-padding text-border-left">稀缺程度 <span
                                    class="iconfont-color">${job.need}</span>家公司需要
                            </div>
                        </div>
                    </div>
    ...
    <div class="container height">
        <div class="row">
            ...
            <div class="text-right col-sm-4">
                <p>微信公众号</p>
                <img src="${pageContext.request.contextPath}/other/images/2524.jpg">
            </div>
        </div>
    </div>
